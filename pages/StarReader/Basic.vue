        ...
        <div class="row">
          ...
          >
            <v-card v-if="myChart.planets[planet_id]" elevation="2" shaped>
              ...
              <p>
                The {{ planet.name }} ({{ planet.symbol }}) is in
              ...
              <v-card-text v-if="planet.char.name">
                Your {{ planet.char.name }}
                <span v-if="planet.char.tribe">
                  is about {{ planet.char.tribe }}</span
                >
                <span v-if="planet.char.place">
                  in the {{ planet.char.place }}</span
                >
              </v-card-text>
              <v-card-actions>
                <v-select
                  ...
                  class="char-selector"
                  :label="'Choose a word for the ' + planet.name"
              ...
              <v-card-actions>
                ...
                <v-select
                  ...
                  "
                  :items="
                    signs_list[myChart.planets[planet_id].sign].keywords.basic
                  "
                >
                  <template v-slot:prepend-item>
                    <v-list-item disabled>
                      <v-list-item-avatar color="grey lighten-3">
                        <v-icon>
                          {{
                            signs_list[myChart.planets[planet_id].sign][
                              'symbol'
                            ]
                          }}
                        </v-icon>
              ...
              <v-card-actions>
                <v-select
                  ...
                  class="char-selector"
                  label="Circumstantial details of the life"
                  :append-outer-icon="
                  ...
                  <template v-slot:prepend-item>
                    <v-list-item disabled>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle>
                          Circumstantial details of the life:
                        </v-list-item-subtitle>
                      </v-list-item-content>
                    </v-list-item>
                    <v-divider class="mb-2"></v-divider>
